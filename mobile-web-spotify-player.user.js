...
(function() {
    ...
    function hideElements() {
      ...
      document.querySelector('button[aria-label="Go back"]').parentElement.style.setProperty('display', 'none', 'important');
      ...
      document.querySelector('button[aria-label="Queue"]').parentElement.parentElement.parentElement.style.setProperty('display', 'none', 'important');
